...
- ExpressJS
    - http://expressjs.com/
- PostgreSQL
    - [DIY: A PostgreSQL database server setup anyone can handle](http://www.techrepublic.com/blog/diy-it-guy/diy-a-postgresql-database-server-setup-anyone-can-handle/)
    - [PostgreeSQL Cheat Sheet](http://www.postgresonline.com/downloads/special_feature/postgresql83_psql_cheatsheet.pdf)
    - [Pluralsight, PostgreSQL: Getting Started](https://www.pluralsight.com/courses/postgresql-getting-started)
- Segurança
...
- Curiosidades
    - [Exemplos de diversos tipos de servidores](https://learn.bevry.me/node/server-simple/)
